        ...
        try {
            ...
            for(int nr = 0; nr<userListObj.length(); nr++){
                ...
                for (int i = 0; i < productsArrayObj.length(); i++) {
                    ...
                    ProductDetailsCartItem productDetailsCartItem = new ProductDetailsCartItem(restaurantName,restaurantGeolocation,restaurantAddress, productId, productName, productPrice, nrProducts);
